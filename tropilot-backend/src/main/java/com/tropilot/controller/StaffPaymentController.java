...
public class StaffPaymentController {
    ...
    public ApiResponse<List<PaymentResponse>> getPendingPayments() {
        return ApiResponse.success("Pending payments loaded successfully", paymentService.getPendingPayments());
    }
    ...
    public ApiResponse<PaymentResponse> approvePayment(
        ...
        return ApiResponse.success(
                ...
                paymentService.approvePayment(id, getUserId(user), request)
        );
    }
    ...
    public ApiResponse<PaymentResponse> rejectPayment(
        ...
        return ApiResponse.success(
                ...
                paymentService.rejectPayment(id, getUserId(user), request)
        );
    }
