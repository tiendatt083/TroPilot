...
public class AdminExpenseController {
    ...
    public ApiResponse<ExpenseResponse> cancelExpense(@PathVariable Long id) {
        return ApiResponse.success("Expense cancelled successfully", expenseService.cancelExpense(id));
    }
}
