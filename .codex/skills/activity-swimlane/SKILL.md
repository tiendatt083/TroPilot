...
Base directory for this skill: /Volumes/Data/AI4BAv2/english-ai-demo/.codex/skills/activity-swimlane
...
```bash
.codex/skills/activity-swimlane/render.sh docs/{feature}/srs/{feature}-{slug}-swimlane.puml --png
